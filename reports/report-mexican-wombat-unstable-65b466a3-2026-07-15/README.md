...
**Branch:** `report-mexican-wombat-unstable-65b466a3-2026-07-15`
**Device:** mexican-wombat-unstable-65b466a3
**Date:** 2026-07-15
**Tool version:** v0.3.3
...
|--------|--------|----------|----------|--------|
| microsoft-bipia | https://github.com/microsoft/BIPIA | 4.13 s | 331 | scanned |
| uiuc-injecagent | https://github.com/uiuc-kang-lab/InjecAgent | 9.03 s | 6924 | scanned |
| lakera-pint-benchmark | https://github.com/lakeraai/pint-benchmark | 2.79 s | 35 | scanned |
| alexh-prompt-injection-scanner | https://github.com/alexh-scrt/prompt-injection-scanner | 2.89 s | 142 | scanned |
| duriantaco-skylos | https://github.com/duriantaco/skylos | 24.18 s | 1371 | scanned |
...
| Target | Source | Duration | Findings | Status |
|--------|--------|----------|----------|--------|
| promptfoo-scenarios | https://www.promptfoo.dev/docs/configuration/scenarios/ | 2.74 s | 11 | scanned |
| promptfoo-webagents | https://www.promptfoo.dev/blog/indirect-prompt-injection-web-agents/ | 2.73 s | 31 | scanned |
...
See `/tmp/safeanalyze-test-config-v033.yaml` on the scanning host for the exact config.
