...
**Branch:** `report-carbonadium-unicorn-taco-046a40ab-2026-07-15`
**Device:** carbonadium-unicorn-taco-046a40ab
**Date:** 2026-07-15
**Tool version:** v0.2.9
...
|--------|--------|----------|----------|--------|
| microsoft-bipia | https://github.com/microsoft/BIPIA | 2.19 s | 297 | scanned |
| uiuc-injecagent | https://github.com/uiuc-kang-lab/InjecAgent | 4.39 s | 2620 | scanned |
| lakera-pint-benchmark | https://github.com/lakeraai/pint-benchmark | 0.21 s | 27 | scanned |
| alexh-prompt-injection-scanner | https://github.com/alexh-scrt/prompt-injection-scanner | 0.26 s | 14 | scanned |
| duriantaco-skylos | https://github.com/duriantaco/skylos | 12.60 s | 1128 | scanned |
...
See `/tmp/safeanalyze-test-config-v029.yaml` on the scanning host for the exact config.
...
- Indirect prompt-injection, tool-injection, delimiter-breakout, encoded-injection, and markdown-injection rules were added in v0.2.8/v0.2.9.
