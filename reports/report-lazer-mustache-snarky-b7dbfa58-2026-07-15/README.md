...
**Branch:** `report-lazer-mustache-snarky-b7dbfa58-2026-07-15`
**Device:** lazer-mustache-snarky-b7dbfa58
**Date:** 2026-07-15
**Tool version:** v0.3.2
...
|--------|--------|----------|----------|--------|
| microsoft-bipia | https://github.com/microsoft/BIPIA | 4.27 s | 332 | scanned |
| uiuc-injecagent | https://github.com/uiuc-kang-lab/InjecAgent | 8.64 s | 6924 | scanned |
| lakera-pint-benchmark | https://github.com/lakeraai/pint-benchmark | 2.68 s | 35 | scanned |
| alexh-prompt-injection-scanner | https://github.com/alexh-scrt/prompt-injection-scanner | 2.83 s | 143 | scanned |
| duriantaco-skylos | https://github.com/duriantaco/skylos | 24.43 s | 1745 | scanned |
...
| Target | Source | Duration | Findings | Status |
|--------|--------|----------|----------|--------|
| promptfoo-scenarios | https://www.promptfoo.dev/docs/configuration/scenarios/ | 2.92 s | 11 | scanned |
| promptfoo-webagents | https://www.promptfoo.dev/blog/indirect-prompt-injection-web-agents/ | 2.68 s | 31 | scanned |
...
See `/tmp/safeanalyze-test-config-v032.yaml` on the scanning host for the exact config.
