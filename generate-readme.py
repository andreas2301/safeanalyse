...
REPORT_DIR = ROOT / "reports" / "report-tactical-beaver-spork-cb4b88a9-2026-07-15"
...
def main():
    ...
    lines = [
        ...
        "",
        f"**Branch:** `report-tactical-beaver-spork-cb4b88a9-2026-07-15`",
        f"**Device:** tactical-beaver-spork-cb4b88a9",
        f"**Date:** 2026-07-15",
