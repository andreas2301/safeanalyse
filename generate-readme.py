...
REPORT_DIR = ROOT / "reports" / "report-mexican-wombat-unstable-65b466a3-2026-07-15"
...
def main():
    ...
    lines = [
        ...
        "",
        f"**Branch:** `report-mexican-wombat-unstable-65b466a3-2026-07-15`",
        f"**Device:** mexican-wombat-unstable-65b466a3",
        f"**Date:** 2026-07-15",
