...
REPORT_DIR = ROOT / "reports" / "report-juggernaut-chimichanga-beaver-01ddce8b-2026-07-15"
...
def main():
    ...
    lines = [
        ...
        "",
        f"**Branch:** `report-juggernaut-chimichanga-beaver-01ddce8b-2026-07-15`",
        f"**Device:** juggernaut-chimichanga-beaver-01ddce8b",
        f"**Date:** 2026-07-15",
