...
REPORT_DIR = ROOT / "reports" / "report-carbonadium-unicorn-taco-046a40ab-2026-07-15"
...
def main():
    ...
    lines = [
        ...
        "",
        f"**Branch:** `report-carbonadium-unicorn-taco-046a40ab-2026-07-15`",
        f"**Device:** carbonadium-unicorn-taco-046a40ab",
        f"**Date:** 2026-07-15",
