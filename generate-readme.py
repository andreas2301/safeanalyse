...
REPORT_DIR = ROOT / "reports" / "report-lazer-mustache-snarky-b7dbfa58-2026-07-15"
...
def main():
    ...
    lines = [
        ...
        "",
        f"**Branch:** `report-lazer-mustache-snarky-b7dbfa58-2026-07-15`",
        f"**Device:** lazer-mustache-snarky-b7dbfa58",
        f"**Date:** 2026-07-15",
