...
REPORT_DIR = ROOT / "reports" / "report-maximum-effort-chimichanga-ff2e39db-2026-07-15"
...
def main():
    ...
    lines = [
        ...
        "",
        f"**Branch:** `report-maximum-effort-chimichanga-ff2e39db-2026-07-15`",
        f"**Device:** maximum-effort-chimichanga-ff2e39db",
        f"**Date:** 2026-07-15",
