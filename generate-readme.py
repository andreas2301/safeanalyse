...
REPORT_DIR = ROOT / "reports" / "report-spicy-beaver-sassy-3edea82c-2026-07-15"
...
def main():
    ...
    lines = [
        ...
        "",
        f"**Branch:** `report-spicy-beaver-sassy-3edea82c-2026-07-15`",
        f"**Device:** spicy-beaver-sassy-3edea82c",
        f"**Date:** 2026-07-15",
